...
#' @title Build Constraint Matrix for Non-decreasing Monotonicity (High-Speed Version)
#'
#' @description
#' Identical to \code{monotonocity_matrix} but without the N zero-columns used
#' to pad the error variables, which do not exist in the high-speed LP
#' formulation. The matrix has 1 + total number of basis functions columns.
#'
#' @param it_list
#' A \code{list} containing the set of intervals by input.
#'
...
#'
#' @return
#' A \code{matrix} enforcing non-decreasing monotonicity in the high-speed LP.

monotonocity_matrix_hs <- function (
    it_list,
    Bp_list
    ) {
...
#' @title Build Constraint Matrix for Concavity (High-Speed Version)
#'
#' @description
#' Identical to \code{concavity_matrix} but without the N zero-columns used
#' to pad the error variables, which do not exist in the high-speed LP
#' formulation.
#'
#' @param Bp_list
...
#'
#' @return
#' A \code{matrix} enforcing concavity in the high-speed LP.

concavity_matrix_hs <- function (
    Bp_list
    ) {
